...
#pragma endregion
    ...
    while (true) {
        ...
        //dxCommon->GetCommandList()->ResourceBarrier(1, &barrierDesc);
        ...
        //assert(SUCCEEDED(result));
        //// 再びコマンドリストを貯める準備
        //result = dxCommon->GetCommandList()->Reset(commandAllocator.Get(), nullptr);
        //assert(SUCCEEDED(result));

        // DirectX毎フレーム処理　ここまで

        // 04_04まで終わった(つもり)
        // 「 5.リソースバリアを戻す 」の扱いがわからない
        // DirectXCommon.cpp に移してみたけど無理だった
